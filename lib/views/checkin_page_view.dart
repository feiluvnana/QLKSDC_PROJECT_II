...
import '../blocs/checkin_page_bloc.dart';
...
class CheckinPage extends StatelessWidget {
  final Order order;
  const CheckinPage({super.key, required this.order});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: BlocProvider(
        create: (_) => CheckinPageBloc(order),
        child: BlocConsumer<CheckinPageBloc, CheckinState>(
            ...
            builder: (context, state) {
              if (state.renderState == RenderState.waiting) {
                BlocProvider.of<CheckinPageBloc>(context)
              ...
              return Align(
                ...
                child: SizedBox(
                  ...
                  child: Stepper(
                    ...
                    onStepContinue: () {
                      context
                          .read<CheckinPageBloc>()
                          .add(NextStepEvent(context));
                    },
                    onStepCancel: () {
                      context.read<CheckinPageBloc>().add(BackStepEvent());
                    },
                    steps: [
                      //Step1
                      Step(
                      ...
                      Step(
                        ...
                        title:
                            const Text("Nhập thông tin đặt phòng và dịch vụ"),
...
class Form3 extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<CheckinPageBloc, CheckinState>(
                    ...
                    child: Padding(
                      ...
                      child: DateTimePicker(
                        ...
                        validator: Validators(
                            ...
                            .checkOutValidator,
                        initialValue: state.order.checkOut,
                        onChanged: (value) {
                          context
                              .read<CheckinPageBloc>()
                  ...
                  Flexible(
                    child: Padding(
                      ...
                      child: TextFormField(
                        ...
                        initialValue: state.order.attention,
                        maxLines: null,
                        decoration: const InputDecoration(
                          labelText: "Lưu ý",
                          border: OutlineInputBorder(),
            ...
            children: [
                  ...
                  Flexible(
                    ...
                    child: Padding(
                      ...
                      child: TextFormField(
                        ...
                        initialValue: state.order.cat.owner.name,
                        decoration: const InputDecoration(
                  ...
                  Flexible(
                    ...
                    child: Padding(
                      ...
                      child: DropdownButtonFormField<String>(
                        ...
                        value: state.order.cat.owner.gender,
                        onChanged: (value) {},
                        onSaved: (value) {
                          context
                              .read<CheckinPageBloc>()
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  initialValue: state.order.cat.owner.tel,
                  decoration: const InputDecoration(

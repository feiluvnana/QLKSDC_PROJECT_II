...
import '../blocs/walkin_page_bloc.dart';
...
class WalkinPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (_) => WalkinPageBloc(),
      child: BlocConsumer<WalkinPageBloc, WalkinState>(
          ...
          builder: (context, state) {
            if (state.renderState == RenderState.waiting) {
              BlocProvider.of<WalkinPageBloc>(context).add(RequireDataEvent());
              return const Column(
            ...
            SchedulerBinding.instance.addPostFrameCallback((_) {
              BlocProvider.of<WalkinPageBloc>(context)
            ...
            return Align(
              ...
              child: SizedBox(
                ...
                child: Stepper(
                  ...
                  onStepContinue: () {
                    context.read<WalkinPageBloc>().add(NextStepEvent(context));
                  },
                  onStepCancel: () {
                    context.read<WalkinPageBloc>().add(BackStepEvent());
                  },
                  steps: [
                    //Step1
                    Step(
...
class Form3 extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<WalkinPageBloc, WalkinState>(
                    ...
                    child: Padding(
                      ...
                      child: DropdownButtonFormField<String>(
                        ...
                        onChanged: (String? value) {
                          if (value != null) {
                            context.read<WalkinPageBloc>().add(
